...
const input = {
  ...
  price: "2900", confirmationDeposit: "1000", totalSlots: "30", bufferSlots: "5", distanceKm: "230", vehicleType: "BIKE", vehicleRequirements: "Touring-ready bike", difficulty: "MODERATE",
...
describe("normalizeStructuredDraft", () => {
  it("converts typed Gemini JSON into existing Ride Studio row formats", () => {
    const result = normalizeStructuredDraft({
      ...
      origins: [{ city: "Bengaluru", meetingPoint: "Hoskote", departureAt: "2026-07-31T05:00", capacity: "", buffer: "", mergePoint: "Agumbe", routeSummary: "Bengaluru to Agumbe" }],
