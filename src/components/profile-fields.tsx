...
export function ProfileFields({ values, errors = {} }: Props) {
  ...
  return (
    <div className="grid gap-5 sm:grid-cols-2">
      ...
      <label className="text-sm font-semibold text-zinc-200">Phone number <span className="font-normal text-amber-400">· Unverified</span><input type="tel" inputMode="tel" maxLength={24} name="operationalPhone" defaultValue={values.operationalPhone} placeholder="9595333556" className={fieldClass(Boolean(errors.operationalPhone))} {...errorProps("operationalPhone")} /><span className="mt-1.5 block text-xs font-normal text-zinc-600">Indian 10-digit numbers get +91 automatically. Used only for booked-ride operations.</span><FieldError name="operationalPhone" errors={errors} /></label>
      ...
      <label className="text-sm font-semibold text-zinc-200">Emergency contact phone<input type="tel" inputMode="tel" maxLength={24} name="emergencyContactPhone" defaultValue={values.emergencyContactPhone} placeholder="9741118340" className={fieldClass(Boolean(errors.emergencyContactPhone))} {...errorProps("emergencyContactPhone")} /><FieldError name="emergencyContactPhone" errors={errors} /></label>
