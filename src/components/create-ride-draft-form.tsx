  ...
  return <>
    ...
    <form action={action} className="relative mt-8 rounded-3xl border border-white/10 bg-white/[.025] p-7">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        ...
        <label className="text-sm font-semibold sm:col-span-2">Total ride slots<input required type="number" min="1" max="100000" name="totalSlots" defaultValue={values.totalSlots} placeholder="30" className="mt-2 w-full rounded-2xl border border-white/10 bg-black/20 px-4 py-3 outline-none focus:border-orange-500" /><span className="mt-1 block text-xs font-normal text-zinc-600">Overall destination/stay capacity. Starting groups do not split or replace this total.</span></label>
