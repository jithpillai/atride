...
export async function POST(request: Request) {
  try {
    ...
    const body = await request.json() as { purpose?: unknown; communitySlug?: unknown; rideId?: unknown; bookingPaymentId?: unknown; publicId?: unknown; payerReference?: unknown };
    ...
    const asset = await completeMediaUpload(session, {
      ...
      bookingPaymentId: typeof body.bookingPaymentId === "string" ? body.bookingPaymentId : undefined,
