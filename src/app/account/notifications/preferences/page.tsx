  ...
  return <section className="mx-auto min-h-[70vh] max-w-3xl px-5 py-16 lg:px-8">
    ...
    <form action={updateNotificationPreferences} className="relative mt-8 rounded-3xl border border-white/10 bg-white/[.025] p-7">
      <div className="grid gap-4">
        <label className="flex cursor-pointer items-start gap-4 rounded-2xl border border-white/10 p-5"><input type="checkbox" name="emailRideReminders" defaultChecked={emailRideReminders} className="mt-1 size-5 accent-orange-500" /><span><strong className="block text-white">Ride-start reminder email</strong><span className="mt-1 block text-sm leading-6 text-zinc-500">Email me when a confirmed ride enters its final 24-hour window.</span></span></label>
