  ...
  return (
    <section className="mx-auto min-h-[70vh] max-w-5xl px-5 py-16 lg:px-8">
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2">
        <Link href="/account/notifications" className="rounded-3xl border border-orange-400/20 bg-orange-400/[.035] p-7 transition hover:border-orange-400/45 hover:bg-orange-400/[.06]">
          <p className="eyebrow">Notification centre</p>
          <h2 className="mt-3 text-2xl font-black">Ride updates and actions</h2>
          <p className="mt-3 text-sm leading-6 text-zinc-500">See booking confirmations, payment decisions, waitlist offers, and important Guild ride changes in one place.</p>
        </Link>
