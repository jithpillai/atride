...
type Props = { params: Promise<{ slug: string; rideId: string }>; searchParams: Promise<{ saved?: string; statusSaved?: string; staffSaved?: string; announcementSaved?: string; officialAnnouncementSaved?: string; error?: string }> };
